...
module.exports = async (alice, msg) => {
try {
let d = new Date;
...
const sender = alice.decodeJid(msg.key.fromMe ? alice.user.id : isGroup ? msg.key.participant : from)
const pushname = msg.pushName || '-'
const tanggal = moment.tz('Asia/Jakarta').format('DD/MM/YY')

/* FUNCTION ADD DATABASE USER BY alice */
...
// DATABASE GROUP
if (isGroup) {
let metadata = await alice.groupMetadata(from) || {}
